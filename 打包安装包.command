...
cp "dist/$APP/Contents/Resources/THIRD_PARTY_LICENSES.txt" "$STAGE/第三方许可证.txt"
...
⚠️ 从旧版本升级上来的话：两个列表里那条旧的要【先删掉再重新加】。
   本 App 没买苹果开发者签名，每次出新版签名都会变，系统记的还是旧版那份，
   所以开关明明亮着、程序却仍说「缺少权限」。选中它按列表下面的「−」删掉，
   再按「+」把 /Applications 里的本 App 加回来即可。
...
本工具是个人开发的开源软件，不是腾讯官方产品，与腾讯公司无关；
「微信」是腾讯公司的商标。源码与说明：
  https://github.com/shibanyu333/wechat-chat-export
TXT
